          ...
          return (
            ...
            >
              ...
              >
                ...
                {isNear && (
                  <span style={{ color: "#ffc800", marginLeft: 4 }}>← LTP</span>
                )}
              </div>
            </div>
          );
...
export default function MagicPage() {
  ...
  async function syncToday() {
    ...
    setSyncMsg(null);
    try {
      const j = await fetch("/api/magic/today", { method: "POST" }).then((r) =>
        r.json(),
      );
      if (j.error) {
  ...
  async function startImport(resume: boolean) {
    ...
    try {
      ...
      setImportLog((prev) => [
        ...prev,
        { type: "error", message: String(e.message) },
      ]);
    } finally {
      setImporting(false);
    }
  ...
  const mCfg = nifty
    ? M_CONFIG[nifty.marketType as keyof typeof M_CONFIG]
    : null;
        ...
        {(
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              borderBottom:
                tab === t ? "2px solid #00ffe7" : "2px solid transparent",
              background: "none",
            ...
            <>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <div
                      style={{ fontSize: 10, color: "#4a7a8a", marginTop: 3 }}
                    >
                      {mCfg.gapNote} · {mCfg.rangeNote}
                    </div>
                    <div
                      style={{ fontSize: 10, color: "#4a7a8a", marginTop: 2 }}
                    >
                      Day range so far:{" "}
                      <b style={{ color: "#c8e6f0" }}>
              ...
              >
                ...
                >
                  ...
                  {[
                    ...
                    [
                      ...
                      nifty.todayHigh,
                      "#00e676",
                      nifty.todayHigh - nifty.prevClose,
                    ],
                    [
                      "Low",
                      nifty.todayLow,
                      "#ff1744",
                      nifty.todayLow - nifty.prevClose,
                    ],
                        ...
                        {diff != null && (
                          <span
                            style={{
                              fontSize: 9,
                              color:
                                (diff as number) >= 0 ? "#00e676" : "#ff1744",
                              marginLeft: 8,
                            }}
                          >
                            ({sign(diff as number)}
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 9, color: "#4a7a8a", marginBottom: 10 }}
                  >
                  ...
                  {nearLevel && (
                    <div
                      style={{ marginTop: 8, fontSize: 9, color: "#ffc800" }}
                    >
                      ⚡ Nearest level: <b>{nearLevel.k.toUpperCase()}</b> (
                      {fmt(nearLevel.d, 0)} pts away)
                    </div>
                  )}
                </div>
                ...
                >
                  ...
                  {[
                    [
                      "BANK NIFTY",
                      liveData?.bankNifty?.ltp,
                      liveData?.bankNifty?.pChange,
                    ],
                    [
                      "INDIA VIX",
                      liveData?.indiaVix?.value,
                      liveData?.indiaVix?.pChange,
                    ],
                  ].map(([name, val, chg]) => (
                    <div
                      key={String(name)}
                  ...
                  {liveData?.usdinr?.price > 0 && (
                    ...
                    >
                      ...
                      <div
                        style={{ fontSize: 9, color: "#4a7a8a", marginTop: 3 }}
                      >
                        Market impact:{" "}
                        <span
                          style={{
                            color:
                              liveData.usdinr.marketImpact >= 0
                                ? "#00e676"
                                : "#ff1744",
                          }}
                        >
                  ...
                  {liveData?.giftNifty?.price > 0 && (
                    <div style={{ padding: "8px 0" }}>
                      ...
                      <div
                        style={{ fontSize: 9, color: "#4a7a8a", marginTop: 2 }}
                      >
                        Direction:{" "}
                        <span
                          style={{
              ...
              {liveData?.keyStocks?.length > 0 && (
                ...
                >
                  ...
                  >
                    {STARCAST.map((sc) => {
                      const s = liveData.keyStocks?.find(
                        (k: any) => k.symbol === sc.symbol,
                      );
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ color: "#4a7a8a", lineHeight: 1.8 }}>
                          ...
                          <div>
                            Expected range:{" "}
                            {type === "FLAT" ? "72–84" : "135–150"} pts
                          </div>
                          {st && (
                            <div style={{ color: "#c8e6f0", marginTop: 4 }}>
                              Historical avg: <b>{fmt(st.avg_range, 0)} pts</b>{" "}
                              · Accuracy:{" "}
                              <b style={{ color: "#00e676" }}>
                                {pct(
                                  Number(st.theory_correct),
                                  Number(st.total),
                                )}
                              </b>
                            </div>
      ...
      {tab === "history" && (
        <div>
          ...
          >
            ...
            {["", "FLAT", "POSITIVE", "NEGATIVE"].map((f) => (
              <button
                ...
                style={{
                  ...
                  background:
                    filterType === f ? "rgba(0,255,231,0.08)" : "none",
            ...
            <span
              style={{ marginLeft: "auto", fontSize: 10, color: "#4a7a8a" }}
            >
          ...
          {loading && (
            <div style={{ textAlign: "center", padding: 40, color: "#4a7a8a" }}>
              Loading…
            </div>
          )}
                    ...
                    return (
                      <tr
                        ...
                        style={{
                          ...
                          background:
                            i % 2 === 0 ? "transparent" : "rgba(8,15,20,0.5)",
                        }}
                      >
                        <td
                          style={{
                        ...
                        <td
                          style={{
                            ...
                            fontFamily: "'Space Mono',monospace",
                            color:
                              r.open >= r.prev_close ? "#00e676" : "#ff1744",
                          }}
                        >
                          {fmt(r.open)}
                        </td>
        ...
        <div>
          ...
          {!loading && !overall && (
            <div style={{ textAlign: "center", padding: 60, color: "#4a7a8a" }}>
              <div style={{ fontSize: 32 }}>📊</div>
              <div style={{ marginTop: 12 }}>
                No data yet. Import history first.
              </div>
            </div>
          )}
          {overall && (
            <>
                ...
                >
                  {[
                    ...
                    [
                      "Overall Accuracy",
                      pct(
                        Number(overall.total_correct),
                        Number(overall.total_days),
                      ),
                      "#00ffe7",
                    ],
                    [
                      "Avg Day Range",
                      fmt(overall.avg_range, 0) + " pts",
                      "#c8e6f0",
                    ],
                  ].map(([label, val, color]) => (
              ...
              >
                {["FLAT", "POSITIVE", "NEGATIVE"].map((mtype) => {
                  ...
                  const accPct =
                    Number(st.total) > 0
                      ? (
                          (Number(st.theory_correct) / Number(st.total)) *
                          100
                        ).toFixed(1)
                      : 0;
                  return (
                      ...
                      >
                        {[
                          ...
                          [
                            "Accuracy",
                            accPct + "%",
                            Number(accPct) >= 60 ? "#00e676" : "#ff1744",
                          ],
                          [
                            "Avg Range",
                            fmt(st.avg_range, 0) + " pts",
                            "#c8e6f0",
                          ],
                          [
                            "Min Range",
                            fmt(st.min_range, 0) + " pts",
                            "#4a7a8a",
                          ],
                          [
                            "Max Range",
                            fmt(st.max_range, 0) + " pts",
                            "#4a7a8a",
                          ],
                          ["Avg Gap", fmt(st.avg_gap, 0) + " pts", cfg.color],
                          [
                            "Avg Pts Moved",
                            fmt(st.avg_pts_moved, 0) + " pts",
                            "#c8e6f0",
                          ],
                        ].map(([label, val, color]) => (
                          <div key={String(label)}>
                        ...
                        >
                          <div
                            style={{
                              ...
                              width: `${accPct}%`,
                              background:
                                Number(accPct) >= 60 ? cfg.color : "#ff1744",
                              borderRadius: 3,
              ...
              >
                ...
                <div>
                  <b style={{ color: "#00ffe7" }}>Market Type</b> is determined
                  by open gap (today open − prev 3:30 PM close):
                </div>
                <div style={{ marginLeft: 12 }}>
                  • FLAT: gap within ±40 pts → theory predicts H-L range ≤ 84
                  pts
                </div>
                <div style={{ marginLeft: 12 }}>
                  • POSITIVE: gap &gt; +40 pts → theory predicts H-L range
                  100–210 pts
                </div>
                <div style={{ marginLeft: 12 }}>
                  • NEGATIVE: gap &lt; -40 pts → theory predicts H-L range
                  100–210 pts
                </div>
                <div style={{ marginTop: 6 }}>
                  <b style={{ color: "#00ffe7" }}>Theory OK (✅)</b> = actual
                  day range fell within the predicted range band.
                </div>
                <div style={{ marginTop: 6, color: "#c8e6f0" }}>
                  All data sourced from Fyers 4hr candles. Last candle close of
                  each day = 3:30 PM close (exact NSE closing price).
                </div>
              </div>
            </>
          )}
      ...
      {tab === "import" && (
        <div>
          ...
          >
            ...
            >
              Fetches Nifty 4hr candles from Fyers in 90-day windows. Extracts
              last candle of each day as 3:30 PM close.
              <br />
              All data stored in Turso. One-time operation — after this, just
              click <b style={{ color: "#00ffe7" }}>SYNC TODAY</b> daily after
              3:30 PM.
            </div>
            <div
              style={{
            ...
            <div style={{ fontSize: 9, color: "#4a7a8a" }}>
              ⚡ IMPORT (RESUME) = skips dates already saved. Safe to run
              multiple times.
              <br />
            ...
            >
              {importLog.map((msg, i) => {
                ...
                return (
                  <div
                    key={i}
                    style={{ color, marginBottom: 3, lineHeight: 1.5 }}
                  >
                    {msg.type === "progress" &&
                    ...
                    {msg.type === "inserting" &&
                      `  💾 Inserting… ${msg.saved}/${msg.total} rows`}
              ...
              {importDone && (
                ...
                >
                  Import complete! Switch to History or Backtest tab to view
                  data.
                </div>
              )}
              <div ref={logEndRef} />
